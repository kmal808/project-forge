    ...
    <div className="min-h-screen bg-secondary py-8">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <Tabs defaultValue="materials" className="space-y-6">
          <TabsList className="bg-white p-1 grid grid-cols-4 gap-1">
            ...
            <TabsTrigger value="punch-list" className="flex items-center justify-center">
            ...
            <TabsTrigger value="walkthrough" className="flex items-center justify-center">
