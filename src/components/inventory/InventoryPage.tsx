...
export function InventoryPage() {
  ...
  const handleExport = () => {
    ...
    a.href = url;
    a.download = `${selectedContainer.containerNumber}-${new Date().toISOString().split('T')[0]}.json`;
    ...
    return (
      <div className="flex h-full items-center justify-center">
        <div className="text-center">
          <h2 className="text-xl font-semibold text-gray-900">Select a Container</h2>
          <p className="mt-2 text-gray-500">Choose a container from the sidebar to view its items</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-lg border border-gray-200 bg-white p-6">
        <ErrorBoundary>
          <h3 className="mb-4 text-lg font-medium text-gray-900">Add New Item</h3>
