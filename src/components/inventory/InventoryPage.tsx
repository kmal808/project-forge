		...
		<div className='space-y-6'>
			<div className='flex items-center justify-between'>
				...
				<div className='flex items-center gap-4'>
					<label className='cursor-pointer rounded-lg bg-primary px-4 py-2 text-sm font-semibold text-gray-700 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50'>
			...
			<div className='rounded-lg border border-gray-200 bg-primary p-6'>
				<ErrorBoundary>
