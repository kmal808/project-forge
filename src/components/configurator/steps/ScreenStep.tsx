...
const screenOptions = [
	{
		...
		icon: Bug,
		features: ['Basic insect protection', 'Good visibility', 'Cost-effective'],
		price: 'Included',
	},
	{
		id: 'better-view',
		...
		icon: Eye,
		features: ['Enhanced visibility', 'Improved airflow', 'Reduced glare'],
		price: '+$45',
	},
	{
		id: 'heavy-duty',
		...
		icon: Shield,
		features: ['Pet resistant', 'Extra durability', 'Enhanced protection'],
		price: '+$65',
	},
	{
		id: 'solar',
		...
		icon: Wind,
		features: ['UV protection', 'Heat reduction', 'Energy saving'],
		price: '+$85',
	},
]
		...
		<div className='space-y-6'>
			<div>
				...
				<p className='mt-1 text-sm text-secondary'>
					Choose a screen that provides the right balance of visibility and
					protection
				</p>
			</div>
				...
				{screenOptions.map((screen) => {
					...
					return (
						<button
							...
							<h3 className='font-medium text-primary'>{screen.name}</h3>
							<p className='mt-1 text-sm text-secondary'>
								{screen.description}
							</p>
